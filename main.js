...
function scrollFunction() {
  if (document.body.scrollTop > 80 || document.documentElement.scrollTop > 80) {
    document.querySelector(".disc").style.boxShadow = "1px 1px 1px grey";
    document.querySelector(".disc").style.backgroundColor = "white";
    document.querySelector(".disc").style.height = "29px";
    ...
    document.querySelector(".sec").style.color = "#262d3d";
    document.querySelector(".about").style.color = "#262d3d";
    document.querySelector(".nes").style.color = "#white";
